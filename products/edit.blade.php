                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            ...
                            @foreach(DB::table('product_translation')->where('Unique',
                            $product->id)->where('language','ar')->get() as $item_product_translation)
                            <input type="text" class="form-control" name="name_ar" placeholder="Product name is Arabic"
                                onchange="update_sku()" value="{{ $item_product_translation->Producer}}" required>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="text" class="form-control" name="unit"
                                placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" value="{{$product->unit}}"
                                required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <div id="thumbnail_img">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-6">
                                    <div class="img-upload-preview">
                                        <img loading="lazy" src="{{ my_asset($product->thumbnail_img) }}" alt=""
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <select name="choice_attributes[]" id="choice_attributes" class="form-control demo-select2"
                                multiple data-placeholder="{{ translate('Choose Attributes') }}">
...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-7">
                <input type="number" min="0" step="0.01" placeholder="{{translate('Purchase price')}}"
        ...
        <div class="form-group">
            ...
            <div class="col-lg-7">
                <input type="number" min="0" step="0.01" placeholder="{{translate('tax')}}" name="tax"
                    class="form-control" value="{{$product->tax}}" required>
            </div>
            <div class="col-lg-1">
                <select class="demo-select2" name="tax_type" required>
                    <option value="amount" <?php if($product->tax_type == 'amount') echo "selected";?>>
                        {{translate('Flat')}}</option>
                    <option value="percent" <?php if($product->tax_type == 'percent') echo "selected";?>>
        ...
        <div class="form-group" id="quantity">
            ...
            <div class="col-lg-7">
                <input type="number" value="{{ $product->current_stock }}" step="1"
...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-lg-9">
                @foreach(DB::table('product_translation')->where('Unique', $product->id)->where('language','ar')->get() as $item_product_translation)
                <textarea class="editor" name="description_ar">{{ $item_product_translation->explained}}</textarea>
                @endforeach
            </div>
        </div>
    </div>
        ...
        <div class="row bord-btm">
            ...
            <div class="col-md-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="number" min="0" step="0.01" placeholder="{{translate('Shipping cost')}}"
                            name="flat_shipping_cost" class="form-control" value="{{ $product->shipping_cost }}"
                            required>
                    </div>
                </div>
            </div>
